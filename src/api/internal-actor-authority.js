...
import { resolveAgentSamBootstrap } from '../../backend/services/bootstrap/resolve.js';
import { getBootstrapKvCache, getMcpPermPointer } from '../../backend/services/bootstrap/kv-cache.js';
import { CURRENT_BOOTSTRAP_COMPILER_VERSION } from '../../backend/services/bootstrap/hash.js';
...
export async function handleInternalActorAuthorityResolve(request, env) {
