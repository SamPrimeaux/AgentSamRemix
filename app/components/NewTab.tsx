...
export const NewTab: React.FC<NewTabProps> = ({ onCreatePage, onLaunchAntigravity }) => {
    ...
    <div className="newtab-page">
      <div className="newtab-content">
        ...
        <div className="newtab-branding">
          <h1 className="newtab-brand-title">AgentSamRemix Browser</h1>
          <p className="newtab-brand-subtitle">Imagine any website, generated in real-time by AgentSam</p>
        </div>
        ...
        <div className="newtab-buttons">
          ...
          {onLaunchAntigravity && (
            ...
            >
              <span className="material-symbols-outlined" style={{ fontSize: '15px', marginRight: '4px', verticalAlign: 'middle' }}>
                terminal
              </span>
              AntiGravity Sandbox
            </button>
